...
/*!
 * \brief Modulo modifié pour traiter correctement les bords i=0 et j=0 avec le mode cyclique activé
...
/*!
 * \brief Compte le nombre de voisins vivants de la cellule (i,j) avec des bords cycliques
 ...
 * \param [in] compte_voisins_vivants Pointeur sur une fonction qui compte les voisants vivants d'une cellule en fonction de la demande de l'utilisateur
 * \param [in] aging Indique si le vieillisement est activé ou désactivé
 */
